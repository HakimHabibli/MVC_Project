...
namespace MVC_App.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        {
            ViewData["ParentCategoryId"] = new SelectList(_context.Categories.Where(c => c.ParentCategoryId == null), "Id", "Title");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Title,ParentCategoryId,Id")] Category category)
        {
            ...
            ViewData["ParentCategoryId"] = new SelectList(_context.Categories.Where(c => c.ParentCategoryId == null), "Id", "Title", category.ParentCategoryId);
            return View(category);
        }
